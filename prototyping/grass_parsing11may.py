...
class Match:
    def __init__(self, aeg: AssociativeEnergyGraph) -> None:
        self.child_energy_lavel_name = str(uuid.uuid4())
        self.child_energy_level = aeg.get_energy_layer(self.child_energy_lavel_name)
    ...
    def reset(self):
        ...
        self.child_energy_level.energy.clear()
